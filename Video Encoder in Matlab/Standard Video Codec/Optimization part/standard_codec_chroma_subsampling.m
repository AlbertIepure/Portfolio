...
%%image
[HUFFMAN_encoded_bitstream_Y,HUFFMAN_encoded_bitstream_Cb,HUFFMAN_encoded_bitstream_Cr, nr_symbols_to_encode_Y,nr_symbols_to_encode_Cb,nr_symbols_to_encode_Cr] = IntraEncode_chr_sub(ORIGINAL_YCbCr_image, N, M, BinCode_1, Codelengths_1, lower_bound_1);
...
DECODED_YCbCr_image = IntraDecode_chr_sub (HUFFMAN_encoded_bitstream_Y,HUFFMAN_encoded_bitstream_Cb,HUFFMAN_encoded_bitstream_Cr, nr_symbols_to_encode_Y,nr_symbols_to_encode_Cb,nr_symbols_to_encode_Cr, BinaryTree_1, height, width, dimensions, N, M, lower_bound_1);
