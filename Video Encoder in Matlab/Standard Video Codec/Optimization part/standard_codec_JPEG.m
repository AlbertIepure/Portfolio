...
%%image
[HUFFMAN_encoded_bitstream_DC_1,HUFFMAN_encoded_bitstream_AC_1, nr_symbols_to_encode_DC_1, nr_symbols_to_encode_AC_1] = IntraEncode_DC_AC(ORIGINAL_YCbCr_image, N, M, BinCode_DC_1, BinCode_AC_1, Codelengths_DC_1, Codelengths_AC_1, lower_bound_DC_1, lower_bound_AC_1);
...
DECODED_YCbCr_image = IntraDecode_DC_AC (HUFFMAN_encoded_bitstream_DC_1, HUFFMAN_encoded_bitstream_AC_1, BinaryTree_DC_1, BinaryTree_AC_1, nr_symbols_to_encode_DC_1, nr_symbols_to_encode_AC_1, height, width, dimensions, N, M, lower_bound_DC_1, lower_bound_AC_1);
...
Bitrate(1) = (length(HUFFMAN_encoded_bitstream_DC_1)+length(HUFFMAN_encoded_bitstream_AC_1))*8 / width / height;
