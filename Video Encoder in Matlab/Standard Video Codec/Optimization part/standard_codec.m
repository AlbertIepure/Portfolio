...
path (path, 'D:/Dropbox/ivc_project/IVC_labs_starting_point/functions');
path (path, 'D:/Dropbox/ivc_project/IVC_labs_starting_point/analysis');
path (path, 'D:/Dropbox/ivc_project/IVC_labs_starting_point/encoder');
path (path, 'D:/Dropbox/ivc_project/IVC_labs_starting_point/decoder');
TRAINING_image = double(imread('D:/Dropbox/ivc_project/IVC_labs_starting_point/data/images/lena_small.tif'));

for i=20:40
    path = ['D:/Dropbox/ivc_project/IVC_labs_starting_point/data/sequences/foreman20_40_RGB/foreman00', num2str(i),'.bmp'];
