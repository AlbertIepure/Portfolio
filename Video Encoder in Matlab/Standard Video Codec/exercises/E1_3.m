...
%% with prefiltering
for i=1:dimensions  
    FILTERED_image(:,:,i) = prefilterlowpass2d(ORIGINAL_image(:,:,i), W2);
    ...
    POSTFILTERED_img(:,:,i) = prefilterlowpass2d(RECONSTRUCTED_image(:,:,i), W2);
...
PSNR_w_prefilter = calcPSNR(MSE_w_prefilter, ORIGINAL_image);
...
PSNR_wo_prefilter = calcPSNR(MSE_wo_prefilter, ORIGINAL_image);
...
save('F:/IVC_labs_starting_point/exercises/w(o)_prefilter','PSNR_wo_prefilter','PSNR_w_prefilter');
