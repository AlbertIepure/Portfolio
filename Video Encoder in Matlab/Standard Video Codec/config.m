...
ParameterStruct(3).name='sail.tif - starting algorithm';                % Name of the investigated compression mode
ParameterStruct(3).input_image_filename='data/images/sail.tif';         % Input image file name
...
ParameterStruct(3).output_stream_filename='data/compressed/sail.ivc';   % Output file name (Compressed)
...
ParameterStruct(3).reconstructed_image_filename='data/reconstructed/sail.tif';    % Output file name (Reconstructed)
