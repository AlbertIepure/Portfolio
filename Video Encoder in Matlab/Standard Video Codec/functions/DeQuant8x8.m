function OUTPUT_block  = DeQuant8x8 (QUANTIZED_block,M)
...
OUTPUT_block(:,:,1) = QUANTIZED_block(:,:,1).*luminance_quantization_table*M;
OUTPUT_block(:,:,2) = QUANTIZED_block(:,:,2).*chrominance_quantization_table*M;
OUTPUT_block(:,:,3) = QUANTIZED_block(:,:,3).*chrominance_quantization_table*M;