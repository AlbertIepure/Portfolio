function [HUFFMAN_encoded_bitstream, nr_symbols_to_encode] = IntraEncode_pred_err(ORIGINAL_YCbCr_image, N, BinCode, Codelengths, search_range)
...
HUFFMAN_encoded_bitstream = enc_huffman_new( zero_run_code + search_range + 1, BinCode, Codelengths);