function OUTPUT_block  = DeQuant8x8_one_layer (QUANTIZED_block,M,i)
...
luminance_quantization_table = [16  11  10  16  24  40  51  61;
 ...
 chrominance_quantization_table = [17  18  24  47  99  99  99  99;
                                   ...
                                   99  99  99  99  99  99  99  99];
if i==1                               
    OUTPUT_block = QUANTIZED_block.*luminance_quantization_table*M;
else
    OUTPUT_block = QUANTIZED_block.*chrominance_quantization_table*M;
end