function [predictedFrame] = compensatemotionbidirectionally(referenceFrame02,referenceFrame00,motionMatrix, mbDim,isHPEnabled)
dimensions = size ( referenceFrame00 );
height = dimensions(1);
width = dimensions(2);
