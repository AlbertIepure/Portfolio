function [HUFFMAN_encoded_bitstream_Y,HUFFMAN_encoded_bitstream_Cb,HUFFMAN_encoded_bitstream_Cr, nr_symbols_to_encode_Y,nr_symbols_to_encode_Cb,nr_symbols_to_encode_Cr] = IntraEncode_chr_sub(ORIGINAL_YCbCr_image, N, M, BinCode, Codelengths, lower_bound)
