...
h=figure
[fs,history] = sequentialfs(fun,X,y,'cv',c,'direction','backward','options',opts,'Nf',6)
% [fs,history] = sequentialfs(fun,X,y,'cv',c,'direction','forward','options',opts,'Nf',8)
hold on
...
% [fs,history] = sequentialfs(fun,X,y,'cv','resubstitution','direction','forward','options',opts,'Nf',1)
...
saveTightFigure(h,'CV_resub_MCE_BW_LDA.pdf');
