START_DIR = D:\Dropbox\MÜNCHEN\MSCE\THESIS~1\WORKIN~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2015b
MAKEFILE = linelikeness_mex.mk

include linelikeness_mex.mki
...
SRC_FILES =  \
	...
	linelikeness_emxutil.c

MEX_FILE_NAME_WO_EXT = linelikeness_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\linelikeness"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\linelikeness/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
