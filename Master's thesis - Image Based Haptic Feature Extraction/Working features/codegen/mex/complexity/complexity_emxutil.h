 ...
 *
 * complexity_emxutil.h
 *
 * Code generation for function 'complexity_emxutil'
 *
 */

#ifndef __COMPLEXITY_EMXUTIL_H__
#define __COMPLEXITY_EMXUTIL_H__
...
/* End of code generation (complexity_emxutil.h) */
