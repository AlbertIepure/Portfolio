function bit_error_rate(h_tot,index,rho,thet,phi)
...
for j=1:len_SNR  
        ...
        % Task 2: Student just need to use their code from Task 2 and
        % change the input
        output_equalizer=conv_anyinput_allpass_eqaulaizer(rho,thet,phi,out_channel_plus_noise);
